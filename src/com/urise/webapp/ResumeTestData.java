...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.addContact(ContactType.SKYPE, new Contact(ContactType.SKYPE.getTitle(), "grigory.kislin", "skype:grigory.kislin"));
        resume.addContact(ContactType.MAIL, new Contact(ContactType.MAIL.getTitle(), "gkislin@yandex.ru", "mailto:gkislin@yandex.ru"));
        resume.addContact(ContactType.LINKED, new Contact(ContactType.LINKED.getTitle(), "Профиль LinkedIn", "https://www.linkedin.com/in/gkislin"));
        resume.addContact(ContactType.GITHUB, new Contact(ContactType.GITHUB.getTitle(), "Профиль GitHub", "https://www.github.com/gkislin"));
        resume.addContact(ContactType.STACK, new Contact(ContactType.STACK.getTitle(), "Профиль Stackoverflow", "https://www.stackoverflow.com/users/548473"));
        resume.addContact(ContactType.HOME, new Contact(ContactType.HOME.getTitle(), "Домашняя страница", "gkislin.ru"));

        String personalDescription = "Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям";
        resume.addSection(SectionType.PERSONAL, new SimpleSection(SectionType.PERSONAL.getTitle(), personalDescription));
        String objectiveDescription = "Аналитический склад ума, сильная логика, креативность, инициативность. Пурист кода и архитектуры.";
        resume.addSection(SectionType.OBJECTIVE, new SimpleSection(SectionType.OBJECTIVE.getTitle(), objectiveDescription));
        ...
        resume.addSection(SectionType.ACHIEVEMENT, new BulletedListSection(SectionType.ACHIEVEMENT.getTitle(), achievementDescriptions));
        ...
        resume.addSection(SectionType.QUALIFICATIONS, new BulletedListSection(SectionType.QUALIFICATIONS.getTitle(), qualificationDescriptions));

        List<Experience> experienceDescriptions = new ArrayList<>();
        Map<String, SimpleSection> map = new HashMap<>();
        map.put("10/2013 - Сейчас", new SimpleSection("Автор проекта.",
                "Создание, организация и проведение Java онлайн проектов и стажировок."));
        experienceDescriptions.add(new Experience("Java Online Projects","javaops.ru", new HashMap<>(map)));
        map.clear();
        map.put("10/2014 - 01/2016", new SimpleSection("Старший разработчик (backend)",
                "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, " +
                        ...
                        "JWT SSO."));
        experienceDescriptions.add(new Experience("Wrike","https://www.wrike.com/", new HashMap<>(map)));
        map.clear();
        map.put("04/2012 - 10/2014", new SimpleSection("Java архитектор",
        ...
        experienceDescriptions.add(new Experience("RIT Center","", new HashMap<>(map)));
        map.clear();
        map.put("12/2010 - 04/2012", new SimpleSection("Ведущий программист",
        ...
        experienceDescriptions.add(new Experience("Luxoft (Deutsche Bank)","www.luxoft.ru", new HashMap<>(map)));
        map.clear();
        map.put("06/2008 - 12/2010", new SimpleSection("Ведущий специалист",
        ...
        experienceDescriptions.add(new Experience("Yota","https://www.yota.ru/", new HashMap<>(map)));
        map.clear();
        map.put("03/2007 - 06/2008", new SimpleSection("Разработчик ПО",
        ...
        experienceDescriptions.add(new Experience("Enkata","enkata.com", new HashMap<>(map)));
        map.clear();
        map.put("01/2005 - 02/2007", new SimpleSection("Разработчик ПО",
        ...
        experienceDescriptions.add(new Experience("Siemens AG","https://new.siemens.com/ru/ru.html", new HashMap<>(map)));
        map.clear();
        map.put("09/1997 - 01/2005", new SimpleSection("Инженер по аппаратному и программному тестированию",
                "Тестирование, отладка, внедрение ПО цифровой телефонной станции Alcatel 1000 S12 (CHILL, ASM)."));
        experienceDescriptions.add(new Experience("Alcatel","www.alcatel.ru", new HashMap<>(map)));
        resume.addSection(SectionType.EXPERIENCE, new Organization(SectionType.EXPERIENCE.getTitle(), experienceDescriptions));
        List<Experience> educationDescriptions = new ArrayList<>();
        map.clear();
        map.put("03/2013 - 05/2013", new SimpleSection("\"Functional Programming Principles in Scala\" by Martin Odersky"));
        educationDescriptions.add(new Experience("Coursera","https://www.coursera.org/learn/progfun", new HashMap<>(map)));
        map.clear();
        map.put("03/2011 - 04/2011", new SimpleSection("Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\""));
        educationDescriptions.add(new Experience("Luxoft","http://www.luxoft-training.ru/training/catalog/course.html?ID=22366", new HashMap<>(map)));
        map.clear();
        map.put("01/2005 - 04/2005", new SimpleSection("3 месяца обучения мобильным IN сетям (Берлин)"));
        educationDescriptions.add(new Experience("Siemens AG","http://www.siemens.ru/", new HashMap<>(map)));
        map.clear();
        map.put("09/1997 - 03/1998", new SimpleSection("6 месяцев обучения цифровым телефонным сетям (Москва)"));
        educationDescriptions.add(new Experience("Alcatel","http://www.alcatel.ru/", new HashMap<>(map)));
        map.clear();
        map.put("09/1993 - 07/1996", new SimpleSection("Аспирантура (программист С, С++)"));
        map.put("09/1987 - 07/1993", new SimpleSection("Инженер (программист Fortran, C)"));
        educationDescriptions.add(new Experience("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики",
                "http://www.ifmo.ru/", new HashMap<>(map)));
        map.clear();
        map.put("09/1984 - 06/1987", new SimpleSection("Закончил с отличием"));
        educationDescriptions.add(new Experience("Заочная физико-техническая школа при МФТИ","http://www.school.mipt.ru/", new HashMap<>(map)));
        resume.addSection(SectionType.EDUCATION, new Organization(SectionType.EDUCATION.getTitle(), educationDescriptions));
    ...
    private static void printResume(Resume resume) {
        ...
        System.out.println();
        Arrays.stream(ContactType.values()).map(resume::getContact).filter(Objects::nonNull).forEach(System.out::println);
        Arrays.stream(SectionType.values()).map(resume::getSection).filter(Objects::nonNull).forEach(System.out::println);
    }
}
